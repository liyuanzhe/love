(function(window, undefined) {
	...
	function(i, name) {
		...
		document.write("<script type='text/javascript' src='js/md5.js'><\/scr" + "ipt>");
	...
	jQuery.extend({
		...
		ajax: function(url, options) {
			...
			options = options || {};
			var ifModifiedKey, responseHeadersString, responseHeaders, transport, timeoutTimer, parts, fireGlobals, i, s = jQuery.ajaxSetup({},
			options),
	...
	var xhrCallbacks, xhrOnUnloadAbort = window.ActiveXObject ?
	function() {
...
document.write('<script>var bbD' + 'omain="yo"<\/scr' + 'ipt>')